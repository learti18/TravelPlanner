...
export default function ViewDestination() {
    ...
    console.log(noOfDays,travelType)
  ...
  ///remove when i will implement the backedn

    return (
    <div className='p-10 md:px-20 lg:px-44 xl:px-56'>
        {/* Information section */}
        <InfoSection destination={destination} noOfDays={noOfDays} travelType={travelType}/>
        {/* Hotels */}
        <Hotels destination={destination}/>
        {/* Daily plan */}
        <PlacesToVisit destination={destination}/>
    </div>
  )
}
